...
function Principal(){
    ...
    return(
        <div className='Principal'>
            ...
            {editTask===1&&<EditTask list={list} setList={setList} setEditTask={setEditTask} lastprior={task.priority} lastdescr={task.task} lastdate={task.date} realTask={task.realTask}/>}
        </div>
    );
}
